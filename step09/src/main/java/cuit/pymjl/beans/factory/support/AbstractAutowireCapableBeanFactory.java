...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Object createBean(String beanName, BeanDefinition beanDefinition, Object[] args) throws BeansException {
        ...
        /*
         * 1. 注册实现了 DisposableBean 接口的 Bean 对象
         * 2. 在创建 Bean 对象的实例的时候，需要把销毁方法保存起来，方便后续执行销毁动作进行调用。
         * 3. DisposableBean会被注册到DefaultSingletonBeanRegistry 中的 DisposableBeanMap 中。
         *    去，因为这个接口的方法最终可以被类 AbstractApplicationContext
         *    的 close 方法通过 getBeanFactory().destroySingletons() 调用。
         * 4. 在注册销毁方法的时候，会根据是接口类型和配置类型统一交给DisposableBeanAdapter 销毁适配器类来做统一处理。
         */
    ...
    private Object initializeBean(String beanName, Object bean, BeanDefinition beanDefinition) {
        // 1. 执行Aware接口的初始化方法，为实现该接口的对象注入相关Spring容器对象
